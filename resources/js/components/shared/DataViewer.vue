    ...
    <div class="">
        <div class="box-title">
            ...
            <form class="form-inline pull-right" @submit.prevent="fetchIndexData">
                <label for="search_column">Busca:</label>
        ...
        <div class="box-footer">
            <div class="row">
                <div class="col-lg-12">
                    <div class="displaying">Exibindo {{model.from}} - {{model.to}} de {{model.total}} linhas</div>
                    <div class="pull-right">
                        <form class="form-inline " @submit.prevent="fetchIndexData">
                            <label for="per_page">Linhas por página</label>
